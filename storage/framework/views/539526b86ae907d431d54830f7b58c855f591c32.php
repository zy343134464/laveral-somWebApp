...
<head>
    ...
    <!--pages css-->
    <!-- DataTables -->
    <link rel="stylesheet" href="<?php echo e(url('webFront/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css')); ?>">

    <!-- Theme style -->
    <link rel="stylesheet" href="<?php echo e(url('webFront/dist/css/AdminLTE.min.css')); ?>">
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="<?php echo e(url('webFront/dist/css/skins/_all-skins.min.css')); ?>">
    <!--custom css-->
    <link rel="stylesheet" href="<?php echo e(url('webFront/dist/css/custom/index2.css')); ?>">
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="index2.html" class="logo">
                    <img src="<?php echo e(url('webFront/dist/img/images/som-logo.png')); ?>" alt="som图标">
                    <span>SOM赛事管理系统</span>
                </a>
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<?php echo e(url('webFront/dist/img/user2-160x160.jpg')); ?>" class="user-image" alt="User Image">
                                </a>
                                <div class="circle"></div>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    <li class="user-header">
                                        <img src="<?php echo e(url('webFront/dist/img/user2-160x160.jpg')); ?>" class="img-circle" alt="User Image">
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    <div class="organization-logo">
                        <img src="<?php echo e(url('webFront/dist/img/images/som-somlogo.png')); ?>" alt="机构图标">
                    </div>
...
<!--page js-->
<!-- DataTables -->
<script src="<?php echo e(url('webFront/bower_components/datatables.net/js/jquery.dataTables.min.js')); ?>"></script>
<script src="<?php echo e(url('webFront/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js')); ?>"></script>
<!-- SlimScroll -->
<script src="<?php echo e(url('webFront/bower_components/jquery-slimscroll/jquery.slimscroll.min.js')); ?>"></script>
<!-- FastClick -->
<script src="<?php echo e(url('webFront/bower_components/fastclick/lib/fastclick.js')); ?>"></script>
<!-- AdminLTE App -->
<script src="<?php echo e(url('webFront/dist/js/adminlte.min.js')); ?>"></script>
<!-- AdminLTE for demo purposes -->
<script src="<?php echo e(url('webFront/dist/js/demo.js')); ?>"></script>
<!--custom js-->
<script src="<?php echo e(url('webFront/dist/js/custom/index2.js')); ?>"></script>
</body>
</html>
