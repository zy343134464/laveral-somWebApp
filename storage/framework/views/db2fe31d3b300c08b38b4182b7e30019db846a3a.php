                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="<?php echo e(url('dist/img/person.png')); ?>" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo e(url('/admin/user')); ?>"><i class="fa fa-circle-o"></i>用户列表</a></li>
                        <li><a href="<?php echo e(url('/admin/user/create')); ?>"><i class="fa fa-circle-o"></i>用户注册</a></li>
                        <li><a href="<?php echo e(url('/admin/role')); ?>"><i class="fa fa-circle-o"></i>添加管理员</a></li>
                        <li><a href="<?php echo e(url('/admin/role')); ?>"><i class="fa fa-circle-o"></i>角色管理</a></li>
                    </ul>
                </li>
            </ul>
        </section>
