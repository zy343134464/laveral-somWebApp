...
@section('body')
<br>
<br><h3>{{$information->titile}}</h3>
<form action="{{ url('admin/information/edit/'.$information->id)}}" method="post">
	{{ csrf_field() }}
    <?php echo __('编辑咨询'); ?>
    标题:<input type="text" name="title" value="{{ $information->title}}"><br>
	副标题:<input type="text" name="sec_title" value="{{$information->sec_title}}"><br>
	<div class="col-sm-10">  
