...
<div class="match-guest">
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" ><a href="{{ url('admin/match/rater/'.$id) }}" >评委</a></li>
            <li role="presentation" class="active"><a href="{{ url('admin/match/guest/'.$id) }}" >嘉宾</a></li>
        </ul>
        <div class="content">
            <ul class="judgelist">
                <li class="addjudge">
                    <a href="{{ url('admin/match/findguest/'.$id) }}">
                ...
                <li>
                    <a href="#">
                        <div class="judge-img">
                            ...
                            <a href="{{ url('admin/match/delguest/'.$v->id)}}"><div class="close"><i class="fa fa-close"></i></div></A>
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                       <div class="match-new">
                            <form class="form-horizontal" role="form" action="{{ url('admin/match/editnewguest/') }}" method="post">
                              {{ csrf_field() }}
