	 ...
	 {{ csrf_field() }}
		<div class="match-poster">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control" id="firstname" placeholder="20字内   海报赛事标题" name="show_title">
				</div>
			</div>
			<div class="form-group">
				<label for="firstname" class="col-sm-2 control-label">赛事简介</label>
				<div class="col-sm-5">
					<textarea class="form-control" rows="6" placeholder="50字内"  name="show_introdution"></textarea>
				</div>
			</div>
		</div>
		<div class="match-detailpage">
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" id="firstname" placeholder="赛事标题"  name="detail_title[]">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<textarea class="form-control" rows="6" placeholder="400字内 赛事内容"  name="detail_introdution"></textarea>
				</div>
			</div>
		</div>
		<div class="match-time">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" id="firstname" placeholder="请选择日期和时间" name="collect_start">
				</div>
			</div>
			<div class="form-group">
				<label for="firstname" class="col-sm-2 control-label">征稿结束时间</label>
				<div class="col-sm-4">
					<input type="text" class="form-control" id="firstname" placeholder="请选择日期和时间" name="collect_end">
				</div>
			</div>
			<div class="form-group">
				<label for="firstname" class="col-sm-2 control-label">初审结束时间</label>
				<div class="col-sm-4">
					<input type="text" class="form-control" id="firstname" placeholder="请选择日期和时间" name="review_start">
				</div>
			</div>
			<div class="form-group">
				<label for="firstname" class="col-sm-2 control-label">评分截止时间</label>
				<div class="col-sm-4">
					<input type="text" class="form-control" id="firstname" placeholder="请选择日期和时间" name="review_end">
				</div>
			</div>
			<div class="form-group">
				<label for="firstname" class="col-sm-2 control-label">结果公布时间</label>
				<div class="col-sm-4">
					<input type="text" class="form-control" id="firstname" placeholder="请选择日期和时间" name="public_time">
				</div>
			</div>
		</div>
		<div class="nextPage">
