      ...
      <div class="row">
          <div class="col-sm-12">
            <!-- 标题 -->
              ...
              <div style="width:176px;height:176px;position: relative;display: inline-block;background:#fff;">
                <input type="file" id="asd" @change="onprogress($event)" style="width:100%;height:100%;position: absolute;z-index:1000;display:block;opacity: 0;">
              </div>
              <div style="width:176px;height:176px;position: relative;float:left;">
