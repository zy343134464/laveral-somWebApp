    ...
    <section class="login">
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <h4 class="login-box-msg">短信验证</h4>
                <form action="{{ url('login/sms') }}" method="post" onsubmit="viodForm()">
                    ...
                    <div class="input_hide" style="display:none;">
                        ...
                        <div class="form-group has-feedback">
                            <input type="password"  class="form-control" placeholder="再次输入密码" name="password2" id="password2" > 
                        </div> -->
                    <!-- /.col -->
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <button type="submit" class="btn btn-primary btn-block btn-flat" disabled>登录</button>
                        </div>
                    </div>
                    <!-- /.col -->
                    <div class="row">
                        ...
                        <div class="col-xs-12 loginin">
                            ...
                            <span style="float:right;"><a href="{{ url('forget') }}">忘记密码</a> | <a href="{{ url('reg') }}">注册</a></span>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
